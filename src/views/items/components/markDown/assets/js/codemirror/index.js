...
// coordinates into another coordinate system-list. Context may be one of
...
// Coverts a box from "div" coords to another coordinate system-list.
...
function fromCoordSystem(cm, coords, context) {
  ...
  // First move into "page" coordinate system-list
  if (context == "page") {
    left -= pageScrollX();
    top -= pageScrollY();
...
// Input must be lineSpace-local ("div" coordinate system-list).
...
function Display(place, doc, input, options) {
  ...
  // Wraps everything that needs to exist inside the vertically-padded coordinate system-list
