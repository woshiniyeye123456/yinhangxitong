  ...
  <el-card shadow="never" class="default-card">
    ...
    <el-form label-width="120px"
      ...
      <el-form-item label="任务审批:" prop="finalReviewResult">
        <el-radio-group
          v-model="params.finalReviewResult"
          :disabled="disabled"
        >
          <el-radio
    ...
    >
      <el-form label-width="95px" class="default-search"
               :model="dialogParams" :rules="dialogRules" ref="refDialogForm">
      ...
      <el-form label-width="220px" class="default-search">
        <el-card shadow="never" class="default-card">
          ...
          <el-form-item label="策略名称:">
            <el-input
              readonly
              v-model="strengtheningParams.name"
            ></el-input>
          </el-form-item>
        ...
        <div class="margin-top-20 text-right">
          <el-button
            type="default"
            @click="strengtheningVisible = false"
            size="small"
          >
            关闭
          </el-button>
  ...
  export default {
    ...
    data() {
      return {
        ...
        dialogRules: {
          node_name: [{required: true, message: '请输入:请选择节点', trigger: 'blur'}],
        },
        jump_to_node_name: '',
        previousList: [],
        dialogVisible: false,
      ...
      getPrevious() {
        ...
        this.$api.wf(vars, this, data => {
          ...
          if (data) {
            ...
            this.previousList = this.previousList.filter(it => it.name !== 'createTask');
          }
        });
      },
