<template>
  <el-dialog :title="title" :append-to-body="true" :visible.sync="dialogVisible" width="65%" @close="closeDialog" class="dialog-default">
    <el-form label-width="55px" class="default-search" :model="params" :rules="rules" ref="refForm">
      <el-form-item label="标题:" prop="title">
        <el-input type="text" v-model="params.title" placeholder="标题"></el-input>
      </el-form-item>
      <el-form-item label="父级:" prop="parent_id">
        <el-cascader @change="change" v-model="parent_id" :options="options" :props="{ checkStrictly: true }"
          filterable clearable></el-cascader>
      </el-form-item>
      <el-form-item label="内容:">
        <markdown :height="600" v-model="params.content"></markdown>
      </el-form-item>
      <el-form-item label="附件:">
        <text-upload :modal="false" :defaultFileList="defaultFileList" @update:successFileList="val => fileList = val"
