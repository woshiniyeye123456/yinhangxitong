<template>
  <div class="box-container default-box">
    <res-split-pane allow-resize split-to="columns" :size="defaultSize" :min-size="minSize" :max-size="maxSize" style="height: calc(100% - 24px);width: calc(100% - 24px); left: 12px;">
      ...
      <template slot="secondPane">
        <div class="right-container">
          ...
          <edit-table class="margin-top-5" :tableColumn="tableColumn" :tableData="tableData" :tableOptions="tableOptions"
    ...
    <!-- 弹框详情 -->
    <data-popup title="资料内容" @on-submit="submit" @on-update="update" :params="dialogParams" :visible.sync="dialogVisible"></data-popup>
  </div>
</template>
